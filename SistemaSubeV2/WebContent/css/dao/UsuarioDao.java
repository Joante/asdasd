...
public class UsuarioDao {
	...
	public Usuario traerUsuario3(String pass) throws HibernateException {
		Usuario objeto = null;
		try {
			iniciaOperacion();
			objeto = (Usuario) session.createQuery("from Usuario c where c.password="+pass).uniqueResult();
		}
		finally {
			session.close();
		}
